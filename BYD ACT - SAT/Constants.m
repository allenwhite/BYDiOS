...
+(NSArray *)ACTgetWhereToGoForHelpStrings{
	...
	return @[
		 ...
		 [self setLineSpacing: @"<a href=\"http://www.actstudent.org/sampletest\">ACT.org</a>\n\nACT Practice Tests:\n\n1) Full length test divided by subject\n\n2) Explanations for each answer"],
		 
		 [self setLineSpacing: @"<a href=\"http://www.princetonreview.com/college/free-act-practice-test\">Princeton Review</a>\n\n1) Option to take self-paced test online\n\n2) Option to be tested in person at central location"],
		 
		 [self setLineSpacing: @"<a href=\"http://www.act.org/aap/pdf/Preparing-for-the-ACT.pdf\">Act Practice Test Booklet</a>\n\n1) Ask guidance counselor for a printed copy\n\n2) <a href=\"mailto:beyourdreams@ymail.com\">Email</a> Be Your Dreams for an online version."]
		 ];
}

+(NSArray *)ACTgetTipsToImproveScoreStrings{
	return @[
		 [self setLineSpacing: @"<a href=\"http://www.actstudent.org/sampletest\">ACT Student Practice Test</a>\n\nTake each section of the practice test individually, untimed."],
		 ...
		 [self setLineSpacing: @"Scoring the Test\n\n1) Score the test by determining the number of questions you got correct."],
...
+(NSArray *)ACTgetAboutTheTestStrings{
	return @[
		 ...
		 [self setLineSpacing: @"For more information about what the ACT test consists of visit:\n\n<a href=\"http://www.actstudent.org/testprep/descriptions/\">ACT.org</a>"]
		 ];
}
